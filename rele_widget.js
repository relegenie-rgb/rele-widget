(function(){
  ...
  var DATA = {
    settlement: { q: "정산금은 언제 입금되나요?", a: "정산은 앨범 발매 월(M) 기준 2개월 뒤(M+2)에 지급됩니다.\n\n📅 정산 일정\n• 매월 15일 — 정산 리포트 제공\n• 매월 말일 — 정산금 입금\n\n예시) 1월 발매 → 3월 15일 리포트 → 3월 말 입금\n\n📍 확인 경로\n로그인 > 통계 및 정산 > 정산\n\n※ 해외 플랫폼은 특성상 최대 6개월~1년 소요될 수 있습니다." },
    refund: { q: "환불은 어떻게 진행되나요?", a: "환불은 자동 처리되지 않으며, 직접 해지 신청이 필요합니다.\n\n📍 신청 경로\n1. 로그인\n2. [계정관리] → [상품가입정보] → [상품 해지]\n\n⏱ 처리 기간\n해지 완료 후 카드사 승인 취소까지 영업일 기준 약 3~5일이 소요될 수 있습니다." },
    cancel: { q: "상품 해지는 어떻게 하나요?", a: "아래 순서로 진행해 주세요.\n\n1. 로그인\n2. [계정관리] → [상품가입정보] → [상품 해지]\n\n추가 문의는 이메일로 연락해 주세요.\n📧 rele.help@kt.com" },
    stop: { q: "발매 중지는 어떻게 요청하나요?", a: "아래 순서로 진행해 주세요.\n\n1. 로그인\n2. [내 음악] → [발매 완료] → [앨범 선택] → [발매 중지 요청]\n\n※ 요청이 정상 접수된 이후 서비스 중단이 진행됩니다." },
    transfer: { q: "서비스 종료 시 앨범 이관이 가능한가요?", a: "별도의 앨범 이관 작업은 지원되지 않습니다.\n\n상품 해지 및 서비스 중지 요청이 접수된 경우, 타 유통사 이관에 필요한 데이터(UPC, ISRC 코드 등)는 전달해 드리고 있습니다.\n\n데이터를 받지 못하셨다면 고객센터로 문의해 주세요.\n📧 rele.help@kt.com" }
  };
