 (function(){
  ...
  var CSS = [
    '#grw-bubble{position:fixed!important;bottom:28px!important;right:28px!important;width:56px!important;height:56px!important;background:#0096FF!important;border-radius:50%!important;display:flex!important;align-items:center!important;justify-content:center!important;cursor:pointer!important;box-shadow:0 4px 18px rgba(0,150,255,.38)!important;z-index:2147483647!important;border:none!important;padding:0!important;margin:0!important;transition:transform .18s!important;left:auto!important;top:auto!important}',
    '#grw-bubble:hover{transform:scale(1.07)!important}',
    '#grw-tooltip{position:fixed!important;bottom:96px!important;right:28px!important;background:#fff!important;border-radius:12px 12px 4px 12px!important;padding:11px 14px 11px 14px!important;box-shadow:0 4px 20px rgba(0,0,0,.16)!important;z-index:2147483646!important;max-width:210px!important;left:auto!important;top:auto!important;cursor:pointer!important}',
    '#grw-tooltip::after{content:""!important;position:absolute!important;bottom:-7px!important;right:20px!important;width:14px!important;height:8px!important;background:#fff!important;clip-path:polygon(0 0,100% 0,50% 100%)!important}',
    '#grw-tooltip-title{font-size:12.5px!important;font-weight:600!important;color:#222!important;margin:0 18px 3px 0!important;line-height:1.4!important;white-space:nowrap!important}',
    '#grw-tooltip-sub{font-size:11.5px!important;color:#666!important;margin:0!important;line-height:1.4!important;white-space:nowrap!important}',
    '#grw-tooltip-close{position:absolute!important;top:5px!important;right:7px!important;background:none!important;border:none!important;cursor:pointer!important;color:#bbb!important;font-size:16px!important;line-height:1!important;padding:2px 4px!important}',
    '#grw-tooltip-close:hover{color:#888!important}',
    '#grw-window{position:fixed!important;bottom:100px!important;right:28px!important;width:358px!important;height:550px!important;background:#fff!important;border-radius:18px!important;box-shadow:0 10px 44px rgba(0,0,0,.15)!important;flex-direction:column!important;overflow:hidden!important;z-index:2147483646!important;display:none!important;left:auto!important;top:auto!important;font-family:-apple-system,BlinkMacSystemFont,"Apple SD Gothic Neo","Malgun Gothic",sans-serif!important;font-size:14px!important;color:#222!important}',
    '#grw-window.grw-on{display:flex!important}',
    '#grw-window *{box-sizing:border-box!important}',
    ...
    '#grw-chips{display:flex!important;flex-wrap:wrap!important;gap:6px!important;margin:0 0 9px!important;padding:0!important}',
  ...
  function addMsg(text, role) {
    ...
    var d = document.createElement('div'); d.className = 'grw-msg grw-' + role;
    var b = document.createElement('p'); b.className = 'grw-bbl'; b.textContent = text;
    var s = document.createElement('span'); s.className = 'grw-time'; s.textContent = getTime();
  ...
  function showTyping() {
    var msgs = document.getElementById('grw-msgs');
    var d = document.createElement('div'); d.className = 'grw-typing-wrap'; d.id = 'grw-ty';
  ...
  function ask(key) {
    ...
    addMsg(item.q, 'user'); showTyping();
    setTimeout(function(){ hideTyping(); addMsg(item.a, 'bot'); }, 350);
  }

  function hideTooltip() {
    var tt = document.getElementById('grw-tooltip');
  ...
  function buildTooltip() {
    ...
    tt.id = 'grw-tooltip';
    tt.innerHTML = [
      '<button id="grw-tooltip-close" type="button" aria-label="닫기">×</button>',
      '<p id="grw-tooltip-title">궁금한 점이 있으신가요? 👋</p>',
      '<p id="grw-tooltip-sub">자주 묻는 질문을 확인해보세요!</p>'
    ].join('');
    document.body.appendChild(tt);

    tt.onclick = function(e) {
      if (e.target.id === 'grw-tooltip-close') return;
      hideTooltip();
      document.getElementById('grw-window').classList.add('grw-on');
    };

    document.getElementById('grw-tooltip-close').onclick = function(e) {
      e.stopPropagation();
      hideTooltip();
    };
  }
  ...
  function init() {
    injectCSS();
    buildHTML();
    buildTooltip(); // 페이지 로드되자마자 바로 말풍선 표시
    ...
    document.getElementById('grw-close').onclick = function(e) {
      e.stopPropagation();
    ...
    document.getElementById('grw-mail').onclick = function(e) {
      e.stopPropagation();
      addMsg("이메일로 문의하고 싶어요.", 'user'); showTyping();
      setTimeout(function(){
        hideTyping();
